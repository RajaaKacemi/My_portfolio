...
function Skills({ isDarkMode }) {
    ...
    return (
        ...
        <div className={`flex flex-col justify-center px-8 pt-6 pb-6 ${isDarkMode ? 'bg-black' : 'bg-white'} `}>
    ...
    >
        Coding Skills
            ...
            <div className={`sm:flex justify-between px-46 my-2  `}>
                ...
                {isCertifications && (
                    <>
                        {CertificationsData.map((Certification, index) => (
                            ...
                            <div key={index} className={`p-4 sm:w-1/3 flex-grow flex  `} data-aos="fade-down">
                                ...
                                <div  className="p-4 sm:w-1/2 flex-grow flex ">
                                    <div className={`bg-${isDarkMode ? 'white' : 'black'} border py-4 px-3 flex-grow flex flex-col justify-between`}>
                                        <div className="">
                                            ...
                                            <p className={`${isDarkMode ? 'text-black' : 'text-white'} text-sm text-start pt-3`} data-aos="fade-right">
                                ...
                                <div  className="p-4 sm:w-1/2 flex-grow flex">
                                    <div className={`bg-${isDarkMode ? 'white' : 'black'} border py-4 px-3 flex-grow flex flex-col justify-between`}>
                                        <div className="">
                                            ...
                                            <p className={`${isDarkMode ? 'text-black' : 'text-white'} text-sm text-start pt-2`} data-aos="fade-right">
